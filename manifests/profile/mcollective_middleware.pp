...
class base::profile::mcollective_middleware (
...
#  $middleware_port           = hiera('mcollective::middleware_port'), - validation error
  $middleware_port           = 61613,
  $middleware_ssl_port       = $mco_profile::params::middleware_ssl_port,
  $middleware_user           = 'mcollective',
  $middleware_password       = 'changemeplease',
  $middleware_admin_user     = 'mcollectiveadmin',
  $middleware_admin_password = 'changemepleaseadmin',
) {
